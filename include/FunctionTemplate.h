...
{
	template<class F>
	static typename THINK::function_return_type<R>::type invoke(F f FUNCTION_COMMA FUNCTION_TYPE_ARGS)
	{
...
template<FUNCTION_CLASS_TYPES> struct FUNCTION_VOID_INVOKER
{
	...
	static typename THINK::function_return_type<R>::type invoke(F f FUNCTION_COMMA FUNCTION_TYPE_ARGS)
	{
		THINK_FUNCTION_RETURN(f(FUNCTION_ARGS));
	}
};
...
template<FUNCTION_CLASS_TYPES> struct MEM_FUNCTION_INVOKER
{
	template<class O, class F>
		static typename THINK::function_return_type<R>::type invoke(O o, F f FUNCTION_COMMA FUNCTION_TYPE_ARGS)
	{
...
template<FUNCTION_CLASS_TYPES> struct MEM_FUNCTION_VOID_INVOKER
{
	template<class O, class F>
		static typename THINK::function_return_type<R>::type invoke(O o, F f FUNCTION_COMMA FUNCTION_TYPE_ARGS)
	{
		THINK_FUNCTION_RETURN((o->*f)(FUNCTION_ARGS));
	}
};
...
public:
	...
	inline typename THINK::function_return_type<R>::type operator()(FUNCTION_TYPE_ARGS)
	{
		if(m_type == typeMember)
		{
