...
#ifndef __THINK_TFUNCTION_H__
#define __THINK_TFUNCTION_H__
...
#define THINK_FUNCTION_RETURN(X) X; return unusable ()

#else

#define THINK_FUNCTION_RETURN(X) X
